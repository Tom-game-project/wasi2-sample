...
pub mod host {
    pub mod hello_world {
        ...
        pub mod host_trait {
            ...
            pub fn say_hello(name: &str) -> _rt::String {
                unsafe {
    ...
    pub mod component {
        pub mod tom {
            ...
            pub mod user_funcs {
                ...
                #[doc(hidden)]
                pub(crate) use __export_component_tom_user_funcs_cabi;
                #[cfg_attr(target_pointer_width = "64", repr(align(8)))]
                #[cfg_attr(target_pointer_width = "32", repr(align(4)))]
                struct _RetArea(
                    [::core::mem::MaybeUninit<
...
macro_rules! __export_my_world_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::component::tom::user_funcs::__export_component_tom_user_funcs_cabi!($ty
        with_types_in $($path_to_types_root)*:: exports::component::tom::user_funcs);
    };
}
#[doc(inline)]
